(function (window, angular, chrome, localStorage, undefined) {
    ...
    var DatacontextConfig = function ($q, datacontextUtility) {
        ...
        DatacontextConfig.icons = {
            script: { color: '#EFBE19', text: 'js', icon: 'icon19.png'},
            stylesheet: { color: '#2FA9DA', text: 'css', icon: 'icon19.png'},
            all: { color: '#F3672A', text: 'all', icon: 'icon19.png' },
            none: { color: '#000', text:'', icon: 'icon19_disabled.png'}
        };
    };
